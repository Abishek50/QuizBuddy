...
public class QuizEnvironment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_environment);
        ...
        MediumAdapter mediumAdapter = new MediumAdapter(getSupportFragmentManager(), getLifecycle());
        viewPager2.setAdapter(mediumAdapter);
