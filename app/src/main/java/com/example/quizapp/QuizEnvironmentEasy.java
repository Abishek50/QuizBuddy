...
public class QuizEnvironmentEasy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_environment_easy);
        ...
        EasyAdapter easyAdapter = new EasyAdapter(getSupportFragmentManager(), getLifecycle());
        viewPager2.setAdapter(easyAdapter);
